                    ...
                    <div class="table-responsive">
                        <div class="table-wrapp">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-md-12"><h2><b>Orders</b></b></h2></div>
                            ...
                            <table id="table1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  <?php
                                        $count=1;
                                        $sel_query="Select * from booking ORDER BY name asc;";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="odelete.php?id=<?php echo $row["id"];?>" class="delete" data-toggle="tooltip" title="Delete" style="justify-content: center;"><i class="material-icons text-danger">&#xE872;</i></a>
                                            <input class="rounded btn btn-sm bg-white" type="button" onclick="myFunction(this)" value="Check">
                                            </td>
                                        </tr>
                                    <?php $count++; } ?>
